...
//	}
	...
	public static boolean isValidType(String assetType) { return typeAbbrev.containsKey(assetType); }
	public static boolean isValidStatus(String assetStatus) { return statusAbbrev.containsKey(assetStatus); }

	public static String getTypePlural(String assetType) { return typePlural.get(assetType); }
	public static String getTypeAbbrev(String assetType) { return typeAbbrev.get(assetType); }
