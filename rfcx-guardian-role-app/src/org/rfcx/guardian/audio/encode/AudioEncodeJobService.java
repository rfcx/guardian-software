...
public class AudioEncodeJobService extends Service {
	...
	private AudioEncode audioEncodeJob;
	...
	public void onCreate() {
		super.onCreate();
		this.audioEncodeJob = new AudioEncode();
	...
	private class AudioEncode extends Thread {
		...
		public AudioEncode() {
			super("AudioEncodeJobService-AudioEncode");
		}
								...
								try {
									...
									if (encodeBitRate < 0) {
										...
										if (gZippedFile.exists()) {
											...
											app.rfcxServiceHandler.triggerIntentServiceImmediately("ApiCheckInTrigger");
										}
