...
class MenuPage(tk.Frame):
   def __init__(self, parent, controller):
      ...
      diagnostics_button = tk.Button(self, text = "Diagnotics", fg = 'white', bg = "green", width = 50, height = 2, anchor = 'center', command = lambda : controller.show_frame(Diagnostics))
      diagnostics_button.grid(row = 1, column = 0, sticky = "nsew", columnspan = 5)

      remove_register_button = tk.Button(self, text = "Remove Registration", fg = 'white', bg = "green", width = 50, height = 2, anchor = 'center', command = lambda : controller.show_frame(RemoveRegistrationPage))
      remove_register_button.grid(row = 2, column = 0, sticky = "nsew", columnspan = 5)

      downgrade_button = tk.Button(self, text = "Install Software", fg = 'white', bg = "green", width = 50, height = 2, anchor = 'center', command = lambda : controller.show_frame(SoftwarePage))
