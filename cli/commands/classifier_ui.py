...
class RemoveClassifierPage(tk.Frame):
   ...
   def __init__(self, parent, controller):
      ...
      self.chainsawButton = tk.Button(self, text = "Install v5", fg = 'black', bg = "blue", width = 20, height = 2, anchor = "center", command = lambda: self.install("chainsaw"))
      self.chainsawButton.grid(row = 1, column = 5, sticky = "nsew", columnspan = 5)
      self.elephantButton = tk.Button(self, text = "Install v2", fg = 'black', bg = "blue", width = 20, height = 2, anchor = "center", command = lambda: self.install("asia-elephant-edge"))
      self.elephantButton.grid(row = 2, column = 5, sticky = "nsew", columnspan = 5)

      removeButton = tk.Button(self, text = "Remove all classifiers", fg = "black", bg = "red", width = 50, height = 2, anchor = "center", command = lambda: self.remove())
