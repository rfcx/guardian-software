...
public class AssetLibraryDb {
	...
	static final String C_META_TAG = "meta_tag";
	...
	private static final String[] ALL_COLUMNS = new String[] {  C_CREATED_AT, C_ASSET_ID, C_ASSET_TYPE, C_FORMAT, C_DIGEST, C_FILEPATH, C_FILESIZE, C_META_TAG, C_META_NUMERIC_1, C_META_NUMERIC_2, C_ATTEMPTS, C_LAST_ACCESSED_AT };
	...
	private static String createColumnString(String tableName) {
		...
		sbOut.append("CREATE TABLE ").append(tableName)
			...
			.append(", ").append(C_META_TAG).append(" TEXT")
