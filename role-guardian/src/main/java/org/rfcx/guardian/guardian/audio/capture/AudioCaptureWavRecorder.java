...
//	private static final int TIMER_INTERVAL_UNCOMPRESSED = 480;
    ...
    private final boolean isRecordingUncompressed; //on/off; RECORDING_UNCOMPRESSED / RECORDING_COMPRESSED
    ...
    public static AudioCaptureWavRecorder getInstance(int audioSampleRate) throws Exception {
        ...
        } while (!(getRecorderState() == AudioCaptureWavRecorder.State.INITIALIZING));
