...
echo "3) Waiting for Reboot to Complete..."  
...
echo "   - Boot is nearly Complete...";
sleep 10;
echo "4) Boot Completed... Continuing Setup..."  
sleep 10;


echo "5) System: Setting Default Write Disk to Internal..."
...
sleep 1;
echo "6) System: Disabling WiFi Hotspot Timeout..."  
...
sleep 1;
echo "7) System: Enabling Mobile Data Roaming..."
...
sleep 1;
echo "8) System: Disabling Automatic Timezone Adjustment..."
...
sleep 1;
echo "9) Installing RFCx Guardian Role..."
APK_ROLE="guardian"
...
sleep 1;
echo "10) Installing RFCx Admin Role..."
APK_ROLE="admin"
INSTALL_APK=`$SCRIPT_DIR/../apk/deploy-apk.sh $APK_ROLE nobuild;`
CLOSE_APP=`$ADB shell "input keyevent $KEYCODE_HOME"`
CHECK_INSTALL=`$ADB shell "cat /data/data/org.rfcx.guardian.$APK_ROLE/files/txt/guid"`
...
sleep 1;
echo "11) System: Changing Default SMS App to RFCx Admin..."
...
sleep 1;
echo "12) Installing RFCx Updater Role..."
APK_ROLE="updater"
INSTALL_APK=`$SCRIPT_DIR/../apk/deploy-apk.sh $APK_ROLE nobuild;`
CLOSE_APP=`$ADB shell "input keyevent $KEYCODE_HOME"`
CHECK_INSTALL=`$ADB shell "cat /data/data/org.rfcx.guardian.$APK_ROLE/files/txt/guid"`
