...
java -jar $SCRIPT_DIR/tools/signapk.jar $SCRIPT_DIR/_private/platform.x509.pem $SCRIPT_DIR/_private/platform.pk8 $APK_PATH_UNSIGNED $PROJECT_DIR/tmp/$ROLE-$APK_VERSION.apk;
