...
public class SentinelPositionDb {

	public SentinelPositionDb(Context context, String appVersion) {
		this.VERSION = RfcxRole.getRoleVersionValue(appVersion);
		this.dbSentinelPositionEnclosure = new DbSentinelPositionEnclosure(context);
	}

	private int VERSION = 1;
	static final String DATABASE = "sentinel-position";
	...
	public class DbSentinelPositionEnclosure {

		final DbUtils dbUtils;

		private String TABLE = "enclosure";
		
		public DbSentinelPositionEnclosure(Context context) {
	...
	public final DbSentinelPositionEnclosure dbSentinelPositionEnclosure;
