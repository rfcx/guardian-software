...
public class SwmSleepService extends Service {
    ...
    private SwmDispatchTimeoutService.SwmDispatchTimeoutSvc swmDispatchTimeoutSvc;
    ...
    public void onCreate() {
        super.onCreate();
        this.swmDispatchTimeoutSvc = new SwmDispatchTimeoutService.SwmDispatchTimeoutSvc();
