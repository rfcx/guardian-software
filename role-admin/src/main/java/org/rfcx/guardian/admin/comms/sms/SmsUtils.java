...
public class SmsUtils {
    ...
    public static void processIncomingSms(JSONObject smsObj, Context context) throws JSONException {
        ...
        if (!smsObj.getString("address").equalsIgnoreCase(apiSmsAddress)) {
            ...
            Log.w(logTag, "SMS Received (ID " + msgId + ") from " + smsObj.getString("address") + " at " + DateTimeUtils.getDateTime(Long.parseLong(smsObj.getString("received_at"))) + ": \"" + smsObj.getString("body") + "\"");
