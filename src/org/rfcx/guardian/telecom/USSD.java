...
public class USSD {
        ...
        private static String startMessage = "displayMMIComplete"; //start msg to look for 
        private static String endMessage = "MMI code has finished running"; //stop msg 
        private static String trimMessage="- using text from MMI message: '"; //a msg to remove from the text
                ...
                try { 
                        //sample code taken from alogcat ...
                         ...
                         while (((line = mReader.readLine()) != null)&&(System.currentTimeMillis()<stop)&&(tostop==false)) {
                                 ...
                                 {
                                         if (line.contains(startMessage)) //check if it is a USSD msg
                                         {
                                                ...
                                                if (t>=timestamp-before) found=true; //start of an USDD is found & is recent !
                                                 ...
                                                 //log example : "12-10 20:36:39.321 D/PhoneUtils(  178): displayMMIComplete: state=COMPLETE"
                                                 if (line.contains(endMessage)) tostop=true;
                                                 else {
                                                         ...
                                                         if (v.length>1)        msg+=v[1].replace(trimMessage, "").trim()+"\n";                                                                                                      
