...
public class FactoryDeviceUuid {
	
	private static final String TAG = FactoryDeviceUuid.class.getSimpleName();
	protected static final String PREFS_DEVICE_ID = "device_uuid";
    protected static UUID uuid;

    public FactoryDeviceUuid(Context context, SharedPreferences prefs) {
    	
        if( uuid ==null ) {
            synchronized (FactoryDeviceUuid.class) {
                if( uuid == null) {
