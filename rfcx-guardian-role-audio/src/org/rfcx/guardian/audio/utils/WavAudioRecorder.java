...
public class WavAudioRecorder {
	...
	public static WavAudioRecorder getInstance(int audioSampleRate) {
		...
		} while (!(result.getState() == WavAudioRecorder.State.INITIALIZING));
		return result;
	}
	 ...
	 * 
	 */
	public WavAudioRecorder(boolean uncompressed, int audioSource,
		...
		try {
			...
			if (rUncompressed) { // RECORDING_UNCOMPRESSED
				...
				if (bufferSize < AudioRecord.getMinBufferSize(sampleRate,
					...
					Log.w(WavAudioRecorder.class.getName(),
